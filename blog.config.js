...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MAO"s BLOG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '推动具身智能的边界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-rust-kappa.vercel.app/', // 网站地址
